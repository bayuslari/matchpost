...
export default function LandingPage() {
  return (
    <div className="min-h-dvh h-dvh overflow-auto bg-gradient-to-br from-green-600 via-green-500 to-yellow-400 flex flex-col items-center justify-center p-6 text-white">
